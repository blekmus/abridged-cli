...
export namespace Widgets {
    ...
    class ListElement extends BoxElement implements IHasOptions<ListOptions<ListElementStyle>> {
        ...
        /**
         * Disable all highlight and input events and visual elements.
         */
        interactiveDisable(): void;
        
        /**
         * Enable all highlight and input events and visual elements.
         */
        interactiveEnable(): void;
